      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.menuGroup, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            {/* Halaman Aduan */}
            <TouchableOpacity style={styles.menuItem} onPress={() => router.push("/BuyerComplaint")} activeOpacity={0.7}>
              <View style={styles.menuItemLeft}>
                <Ionicons name="chatbubbles-outline" size={20} color={theme.primary} />
                <Text style={[styles.menuItemText, { color: theme.text }]}>{t("profile.complaint")}</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={theme.textLight} />
            </TouchableOpacity>
            <View style={[styles.divider, { backgroundColor: theme.border }]} />
